      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">O Nás</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index">Domov <i class="ion-ios-arrow-forward"></i></a></span> <span>O Nás</p>
          </div>
        </div>
      </div>
    </section>
